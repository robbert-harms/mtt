...
\frontmatter
	...
	%% Initialize the use of minitocs
	\dominitoc
	
	%% Display the chapters TOC
	\tableofcontents

%% Start the main content
\mainmatter

	%% Correct the right left printer margins
	\flipmargins
...
%% The final part of the book, the backmatter for the bibliography and perhaps the index
\backmatter
